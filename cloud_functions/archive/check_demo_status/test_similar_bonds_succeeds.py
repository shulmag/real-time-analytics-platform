...
@run_multiple_times_before_failing
def test_rhodeisland_aaminus_education():
    '''This caused us an error before, and also tests that there is no 
    error in the response when there are no similar bonds found.'''
    response_dict = response_from_similar_bonds(state='RI', rating='AA-', purposeClass=27)
    bond_description = 'AA- rated Rhode Island education bonds'
