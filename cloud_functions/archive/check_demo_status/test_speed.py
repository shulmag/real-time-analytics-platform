...
## This test has been commented out since this CUSIP has abnormally high yields in the trade history
# @run_multiple_times_before_failing
# def test_744829CX8():
#     '''Tests that pricing CUSIP 744829CX8 takes less than `INDIVIDUAL_SPEED_THRESHOLD` seconds.'''
#     _test_individual_pricing('744829CX8')


## This test has been commented out since this CUSIP is no longer outstanding
# @run_multiple_times_before_failing
# def test_838889GF4():
#     '''Tests that pricing CUSIP 838889GF4 takes less than `INDIVIDUAL_SPEED_THRESHOLD` seconds.'''
#     _test_individual_pricing('838889GF4')


## This test has been commented out since this CUSIP has already matured
# @run_multiple_times_before_failing
# def test_346914ML5():
#     '''Tests that pricing CUSIP 346914ML5 takes less than `INDIVIDUAL_SPEED_THRESHOLD` seconds.'''
#     _test_individual_pricing('346914ML5')


@run_multiple_times_before_failing
def test_61212WCW3():
    '''Tests that pricing CUSIP 61212WCW3 takes less than `INDIVIDUAL_SPEED_THRESHOLD` seconds.'''
    _test_individual_pricing('61212WCW3', quantity=250)
...
@run_multiple_times_before_failing
def test_batch_100():
    '''Batch price an assorted list of 100 CUSIPs that should give a price. Should take less than 12 seconds.'''
    cusip_list = ['56117FAE8', 
                  ...
                  '60637BTL4', 
                  '69671TCQ0']
    _test_batch_pricing(cusip_list, 12)
