'''The only difference between this cloud function and `update_msrb_real_time_trade_messages` is that this one is deployed 
in region us-west-1, and that one is deployed in region us-east-4. Deploying in us-west-1 fixed issues we were having with 
