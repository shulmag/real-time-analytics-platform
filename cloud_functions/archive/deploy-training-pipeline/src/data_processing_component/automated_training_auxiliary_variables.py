...
EMAIL_RECIPIENTS_FOR_LOGS = ['eng@ficc.ai', 'eng@ficc.ai', 'eng@ficc.ai', 'gil@ficc.ai', 'eng@ficc.ai']    # recipients for training logs, which should be a more technical subset of `EMAIL_RECIPIENTS`
...
from ficc.utils.auxiliary_variables import CATEGORICAL_FEATURES, NON_CAT_FEATURES, BINARY, PREDICTORS

othercols  = ['rtrs_control_number', 
              'cusip', 
              'trade_date',
              'trade_datetime', 
              'dollar_price', 
...
COLUMNS_FOR_TRAINING_COMPONENT = set(CATEGORICAL_FEATURES + NON_CAT_FEATURES + BINARY + PREDICTORS + othercols)
