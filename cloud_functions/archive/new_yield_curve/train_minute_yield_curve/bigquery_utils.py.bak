...
etfs = ['FMHI','HYD','HYMB','IBMK','IBML','IBMM','ITM','MLN','MMIN','MUB','PZA', 'SHM', 'SHYD', 'SMB', 'SUB' , 'TFI']
...
def get_scalar_lbd():
    ...
    scalar = sqltodf(f"SELECT * FROM `eng-reactor-287421.yield_curves_v2.standardscaler_parameters_daily` ORDER BY date DESC LIMIT 1")
    return scalar