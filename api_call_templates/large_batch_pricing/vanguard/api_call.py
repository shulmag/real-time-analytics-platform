...
def main():
    ...
    print(f'Getting data as of {current_datetime.strftime('%Y-%m-%d %H:%M:%S')}')
    priced_batches = call_price_batches(USERNAME, PASSWORD, cusip_list_batches, quantity_list_batches, trade_type_list_batches, current_time_string)
